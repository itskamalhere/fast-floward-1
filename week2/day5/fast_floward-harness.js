    ...
    let content = html`
      <page-body title="${this.title}" category="${this.category}" description="${this.description}">
        ...
        <action-card title="DAY 4: Kitty Items Market - Sell Market Item"
          description="Sell a Kitty Item in Marketplace" action="kittyItemsMarketSellMarketItem" method="post"
        ...
        <action-card title="DAY 4: Kitty Items Market - Buy Market Item"
          description="Buy a Kitty Item from Marketplace" action="kittyItemsMarketBuyMarketItem" method="post"
        ...
        <action-card title="DAY 4: Kitty Items Market - Read Sale Collection IDs"
          description="Read the Sale Collection IDs of NFTs for this account" action="kittyItemsMarketReadSaleCollectionIDs"
        ...
        <action-card title="DAY 5: Kibble - Burn Tokens" description="Burn Kibble from an account" action="kibbleBurnTokens"
